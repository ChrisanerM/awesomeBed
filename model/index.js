...
//User class a blue-print Mercedes Benz example. Certain Model but have to meet certain design/ requirements||you only creating a method therefore you don't need an arrow function
//LOGIN
class User {
  login(req, res) {
